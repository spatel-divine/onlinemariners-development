...
.box > .icon > .info > p { font-family: "Roboto",sans-serif !important; font-size: 13px; color: #666; line-height: 1.5em; margin: 20px;padding-top: 4%;}
    ...
    <section class="" style="padding-top: 4%;">
      ...
      <div class="row" style="margin-top: 2.0rem;margin-bottom: 2.0rem;">        
        <div class="col-sm-6">
          ...
          ?>
          <img src="{{ $ourVisionPath }}" width="425" height="250"/>          
          <div class="heading">
            <h2>OUR VISION</h2>
          </div>          
          <p> To create a great place to work by inspiring our people to continuously innovate and bring greater value to our customers and environment, thereby enhancing stakeholder value.</p>
        </div>
        
        <div class="col-sm-6">
          <img src="{{ $ourMisionPath }}" width="425" height="250"/>          
          <div class="heading">
            <h2>OUR MISSION</h2>
          </div>          
          <ul id="mission_bullet">            
