                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="country" class="form-control" id="country" required>
                      ...
                      <option value="{{ $country->id }}" {{ ($employer[0]->country == $country->id) ? "selected" :""}}>{{ $country->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="state" class="form-control" id="state" required>
                      ...
                      <option value="{{ $state->id }}" {{ ($employer[0]->state == $state->id) ? "selected" :""}}>{{ $state->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>                
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="city" class="form-control" id="city" required>
                      ...
                      <option value="{{ $city->id }}" {{ ($employer[0]->city == $city->id) ? "selected" :""}}>{{ $city->name }}</option>
                      @endforeach
                    </select>
