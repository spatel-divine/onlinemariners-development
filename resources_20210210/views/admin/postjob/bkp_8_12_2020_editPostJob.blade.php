                            ...
                            <table id="BoxTable">
                                ...
                                <tbody id="appendhere">
                                  <tr id="TemplateRow" class="MyClass">
                                    ...
                                    <td>
                                        <input type="number" class ="BoxValClass form-control" name="wage[]"  id="BoxVal"  placeholder="Enter wage" required />
                                    </td>                      
                                  </tr>
                                </tbody>
                              </table>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <select name='country' class="form-control" id="country" required>
                        ...
                        <option value="{{ $country->name }}" {{ ($postjobs[0]->country == $country) ? "selected":"" }}>{{ $country->name }}</option>
                        @endforeach
                      </select>
                  </div>
                </div>  
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <select name='state' class="form-control" id="State" required>
                        ...
                        <option value="{{ $state->name }}" {{ ($postjobs[0]->state == $state) ? "selected":"" }}>{{ $state->name }}</option>
                        @endforeach
                      </select>
                  </div>
                </div>
