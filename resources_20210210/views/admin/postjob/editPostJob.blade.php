 ...
 -->
              ...
              <!-- Joining port -->
               <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="joining_port" class="form-control" placeholder="Enter your joining" 
...
//         // document.getElementById("whereToPrint").innerHTML = JSON.stringify(obj);
        ...
        if (wage != "") 
        {
            ...
            // $.each(aVal, function(i, value) {   
              ...
              result +="<thead><tr><th>Rank</th><th>Contract Duration(In Months)</th><th>Wage(In Dollar)</th></tr></thead>";
          $.each(obj,function(i,ob){
            ...
            result +="<td><input type='number' class='BoxValClass form-control col-sm-3' name='wage[]' id='BoxVal' placeholder='Enter wage' value='"+ob.wages+"'' ></td></tr>";
