											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="form-group">
														...
														<input type="number" name="landline_number" class="form-control" placeholder="Landline Number" value="{{ old('landline_number') }}">
													</div>	
												</div>
											</div>																	
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="form-group">
														...
														<input type="number" name="landline_number" class="form-control" placeholder="Landline Number" value="{{ $employerData->landline_number }}">
													</div>	
												</div>
											</div>																	
											...
											<div class="row">
												<div class="col-sm-6 form-group">
													...
													<select name="city" class="form-control" id="CityUpdate" required>
									                    ...
									                    <option value="{{ $city->id }}" {{ ($employerData->city == $city->id) ? "selected" :""}}>{{ $city->name }}</option>
									                    @endforeach
							                		</select>
												</div>
												<div class="col-sm-6"></div>
