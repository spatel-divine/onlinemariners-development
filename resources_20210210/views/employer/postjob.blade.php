                    ...
                    <!-- end of Unread message flash -->
								...
								<div class="dashboard-caption">
									...
									<div class="dashboard-caption-header">
										<h4><i class="ti-ruler-pencil"></i>Post New Job</h4>
									</div>
											...
											<div class="row" style="padding-bottom: 20px;">
												<div class="col-sm-12">
													<input class="btn btn-info" type='button' value='+ Add' id='addButton'>
  													<input class="btn btn-warning" type='button' value='- Remove' id='removeButton'>
												</div>
											</div>
										<!--Dynamic row with wage row -->	
								<div class="card-box">
										        ...
										        <table id="BoxTable">
										            ...
										            <tbody id="appendhere">
										              <tr id="TemplateRow" class="MyClass">
										                ...
										                <td>
										                    <input type="number" step=0.01 name="contract_duration[]"  Step 0.5 class="form-control" required />
										                </td>
										                <!-- <td>
										                    <input type="number" step=0.01 name="experience_years[]"  Step 0.5 class="form-control" required />
										                </td> -->
										                <td>
										                    <input type="number" class ="BoxValClass form-control" name="wage[]"  id="BoxVal"  />
										                </td>                      
										              </tr>
										            </tbody>
									            </table>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="form-group">
														...
														<input type="text" name="app_deadline" id="app_deadline" class="form-control" placeholder="Enter Application Deadline date" value="">
													</div>	
												</div>
												<!-- Vassel Type -->
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="form-group">
														...
														<input type="text" name="joining_port" class="form-control" placeholder="Enter Port of Joining" value="{{ old('joining_port') }}" required>
													</div>	
												</div>
											</div>
