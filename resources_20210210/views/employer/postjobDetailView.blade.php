	...
	<div class="container">
		<div class="col-md-12 col-sm-12">
			...
			<div class="alert alert-success alert-dismissable fade in" style="padding: 2% 0">
                ...
                <p style="padding-left: 18px; text-transform: uppercase;">Kindly, Check our <a href="http://onlinemariners.com/knowledgeBase" target="_blank">Knowledgebase</a> page to know how to post a job for candidate and other operations.For other issue contact support. </p>
            </div>
			@if( session('success') )
