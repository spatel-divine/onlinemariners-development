                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="left" style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        Candidate {{ $data['candidate_name'] }} has applied for the rank of  {{ $data['rank_position'] }}.Currently their, application status is <strong><u>pending</u></strong>. Take further steps by signing in to your employer account.
                                    </td>
                                </tr>
