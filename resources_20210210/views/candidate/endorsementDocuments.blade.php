                                            ...
                                            <form name="medical_doc_form" method='POST' action="{{ route('medicaldoc.save') }}">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Doc Name</th>
                                                        <th>Do you have it?</th>
                                                        <th id='document_valid_th'>Is Document valid?</th>                                    
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                            ...
                                            <form name="skill_trainging_doc_form" method='POST' action="{{ route('skilldoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('stc',1, 1)" type="radio" name="is_arpa" class="rb_arpa_yes" value="1" {{(isset($travel[0]->is_arpa) && ($skill[0]->is_arpa == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('pd',1, 1)" type="radio" name="is_driver_license" class="rb_driver_lice_no"  value="0" {{(isset($personal[0]->is_driver_license) && ($personal[0]->is_driver_license == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                           <div class="col-sm-4">
                                            ...
                                            <form name="stcwdoc_form" method='POST' action="{{ route('stcwdoc.save') }}">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',6, 1)" type="radio" name="is_crowd_mgt_training" class="rb_cmgttra_yes" value="1" {{(isset($stcw[0]->is_crowd_mgt_training) && ($stcw[0]->is_crowd_mgt_training == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',6, 0)" type="radio" name="is_crowd_mgt_training" class="rb_cmgttra_yes" value="0" {{(isset($stcw[0]->is_crowd_mgt_training) && ($stcw[0]->is_crowd_mgt_training == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_crowd_mgt_training_disabled}} type="radio" name="crowd_mgt_training_status"  class="rb_end_deco_yes STCW_6" value="yes" {{ ( isset($stcw[0]->crowd_mgt_training_status) && ($stcw[0]->crowd_mgt_training_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_crowd_mgt_training_disabled}} type="radio" name="crowd_mgt_training_status"  class="rb_end_deco_no STCW_6" value="no" {{ ( isset($stcw[0]->crowd_mgt_training_status) && ($stcw[0]->crowd_mgt_training_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',7, 1)" type="radio" name="is_safety_training_for_personnel_providing_ds" class="rb_safetpdstopp_yes" value="1" {{(isset($stcw[0]->is_safety_training_for_personnel_providing_ds) && ($stcw[0]->is_safety_training_for_personnel_providing_ds == '1') ) ? 'checked': ''  }}> Yes </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',7, 0)" type="radio" name="is_safety_training_for_personnel_providing_ds" class="rb_safetpdstopp_no" value="0" {{(isset($stcw[0]->is_safety_training_for_personnel_providing_ds) && ($stcw[0]->is_safety_training_for_personnel_providing_ds == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_safety_training_for_personnel_providing_ds_disabled}} type="radio" name="safety_training_for_personnel_providing_ds_status"  class="rb_end_deco_yes STCW_7" value="yes" 
                                                            ...
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_safety_training_for_personnel_providing_ds_disabled}} type="radio" name="safety_training_for_personnel_providing_ds_status"  class="rb_end_deco_no STCW_7" value="no" {{ ( isset($stcw[0]->safety_training_for_personnel_providing_ds_status) && ($stcw[0]->safety_training_for_personnel_providing_ds_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',8, 1)" type="radio" name="is_crisis_mgt_human_behaviour_training" class="rb_cmgtht_yes" value="1" {{(isset($stcw[0]->is_crisis_mgt_human_behaviour_training) && ($stcw[0]->is_crisis_mgt_human_behaviour_training == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',8, 0)" type="radio" name="is_crisis_mgt_human_behaviour_training" class="rb_cmgtht_no" value="0" {{(isset($stcw[0]->is_crisis_mgt_human_behaviour_training) && ($stcw[0]->is_crisis_mgt_human_behaviour_training == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_crisis_mgt_human_behaviour_training_disabled}} type="radio" name="crisis_mgt_human_behaviour_training_status"  class="rb_end_deco_yes STCW_8" value="yes" {{ ( isset($stcw[0]->crisis_mgt_human_behaviour_training_status) && ($stcw[0]->crisis_mgt_human_behaviour_training_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_crisis_mgt_human_behaviour_training_disabled}} type="radio" name="crisis_mgt_human_behaviour_training_status"  class="rb_end_deco_no STCW_8" value="no" {{ ( isset($stcw[0]->crisis_mgt_human_behaviour_training_status) && ($stcw[0]->crisis_mgt_human_behaviour_training_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',9, 1)" type="radio" name="is_passenger_cargo_hull_integrity_training" class="rb_hullinte_cs_yes" value="1" {{(isset($stcw[0]->is_passenger_cargo_hull_integrity_training) && ($stcw[0]->is_passenger_cargo_hull_integrity_training == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',9, 0)" type="radio" name="is_passenger_cargo_hull_integrity_training"  class="rb_hullinte_cs_no" value="0"  {{(isset($stcw[0]->is_passenger_cargo_hull_integrity_training) && ($stcw[0]->is_passenger_cargo_hull_integrity_training == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_passenger_cargo_hull_integrity_training_disabled}} type="radio" name="passenger_cargo_hull_integrity_training_status"  class="rb_end_deco_yes STCW_9" value="yes" {{ ( isset($stcw[0]->passenger_cargo_hull_integrity_training_status) && ($stcw[0]->passenger_cargo_hull_integrity_training_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_passenger_cargo_hull_integrity_training_disabled}} type="radio" name="passenger_cargo_hull_integrity_training_status"  class="rb_end_deco_no STCW_9" value="no" {{ ( isset($stcw[0]->passenger_cargo_hull_integrity_training_status) && ($stcw[0]->passenger_cargo_hull_integrity_training_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',10, 1)" type="radio" name="is_basic_safety_tc" class="rb_basicstc_yes" value="1" {{(isset($stcw[0]->is_basic_safety_tc) && ($stcw[0]->is_basic_safety_tc == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('STCW',10, 0)" type="radio" name="is_basic_safety_tc" class="rb_basicstc_no" value="0" {{(isset($stcw[0]->is_basic_safety_tc) && ($stcw[0]->is_basic_safety_tc == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_basic_safety_tc_disabled}} type="radio" name="basic_safety_tc_status"  class="rb_end_deco_yes STCW_10" value="yes" {{ ( isset($stcw[0]->basic_safety_tc_status) && ($stcw[0]->basic_safety_tc_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_basic_safety_tc_disabled}} type="radio" name="basic_safety_tc_status"  class="rb_end_deco_no STCW_10" value="no" {{ ( isset($stcw[0]->basic_safety_tc_status) && ($stcw[0]->basic_safety_tc_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                           ...
                                           <form name="offshore_form" method='POST' action="{{ route('Offshoredoc.save') }}">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_boat_disabled}} type="radio" name="boat_offshore_safely_by_boat_status"  class="rb_end_deco_yes OCER_7" value="yes" {{ ( isset($offshore[0]->boat_offshore_safely_by_boat_status) && ($offshore[0]->boat_offshore_safely_by_boat_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_boat_disabled}} type="radio" name="boat_offshore_safely_by_boat_status"  class="rb_end_deco_no OCER_7" value="no" {{ ( isset($offshore[0]->boat_offshore_safely_by_boat_status) && ($offshore[0]->boat_offshore_safely_by_boat_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                               ...
                               <?php /*
                                <div class="panel panel-default" id="yacht_tab9">
                                    <div class="panel-heading" role="tab" id="headingNine">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseNine" aria-expanded="false" aria-controls="collapseNine" {{($return_tab && $return_tab=="yacht_tab") ? ' style="background-color:#03a84e;color:white"' : ''}} class='{{($return_tab && $return_tab=="yacht_tab") ? '' : 'collapsed'}}'>
                                                
                                                Yacht Certification
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseNine" class="panel-collapse  {{($return_tab && $return_tab=='yacht_tab') ? 'collapse in' : 'collapse'}}" role="tabpanel" aria-labelledby="headingNine">
                                        @if( session('success') && $return_tab == 'yacht_tab')
                                            <div class="msg alert alert-success alert-dismissable fade in msg_diplay" style="margin: 1% 0;">
                                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                <b>Success ! </b>{{ session('success') }}
                                            </div>
                                        @endif
                                        <!-- Flash Msg on success-->
                                        @if( session('error')  && $return_tab == 'yacht_tab')
                                            <div class="msg alert alert-danger alert-dismissable fade in msg_diplay" style="margin: 1% 0;">
                                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                <b>Error ! </b>{{ session('error') }}
                                            </div>
                                            ...
                                            <form name="yacht_form" method='POST' action="{{ route('yachtdoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',1, 1)" type="radio" name="is_advanced_powerboat_certificate" class="rb_advpowc_yes" value="1" {{(isset($yacht[0]->is_advanced_powerboat_certificate) && ($yacht[0]->is_advanced_powerboat_certificate == '1') ) ? 'checked': ''  }}> Yes </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',1, 0)" type="radio" name="is_advanced_powerboat_certificate" class="rb_advpowc_no" value="0" {{(isset($yacht[0]->is_advanced_powerboat_certificate) && ($yacht[0]->is_advanced_powerboat_certificate == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_advanced_powerboat_certificate_disabled}} type="radio" name="advanced_powerboat_certificate_status"  class="rb_end_deco_yes YACHT_1" value="yes" {{ ( isset($yacht[0]->advanced_powerboat_certificate_status) && ($yacht[0]->advanced_powerboat_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_advanced_powerboat_certificate_disabled}} type="radio" name="advanced_powerboat_certificate_status"  class="rb_end_deco_no YACHT_1" value="no" {{ ( isset($yacht[0]->advanced_powerboat_certificate_status) && ($yacht[0]->advanced_powerboat_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',2, 1)" type="radio" name="is_basic_sea_survival_certificate" class="rb_seaservival_yes" value="1" {{(isset($yacht[0]->is_basic_sea_survival_certificate) && ($yacht[0]->is_basic_sea_survival_certificate == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',2, 0)" type="radio" name="is_basic_sea_survival_certificate" class="rb_seaservival_no" value="0" {{(isset($yacht[0]->is_basic_sea_survival_certificate) && ($yacht[0]->is_basic_sea_survival_certificate == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_basic_sea_survival_certificate_disabled}} type="radio" name="basic_sea_survival_certificate_status"  class="rb_end_deco_yes YACHT_2" value="yes" {{ ( isset($yacht[0]->basic_sea_survival_certificate_status) && ($yacht[0]->basic_sea_survival_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_basic_sea_survival_certificate_disabled}} type="radio" name="basic_sea_survival_certificate_status"  class="rb_end_deco_no YACHT_2" value="no" {{ ( isset($yacht[0]->basic_sea_survival_certificate_status) && ($yacht[0]->basic_sea_survival_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',3, 1)" type="radio" name="is_csy_offshore_certificate" class="rb_costyoffsc_yes" value="1" {{(isset($yacht[0]->is_csy_offshore_certificate) && ($yacht[0]->is_csy_offshore_certificate == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',3, 0)" type="radio" name="is_csy_offshore_certificate" class="rb_costyoffsc_no" value="0" {{(isset($yacht[0]->is_csy_offshore_certificate) && ($yacht[0]->is_csy_offshore_certificate == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_csy_offshore_certificate_disabled}} type="radio" name="csy_offshore_certificate_status"  class="rb_end_deco_yes YACHT_3" value="yes" {{ ( isset($yacht[0]->csy_offshore_certificate_status) && ($yacht[0]->csy_offshore_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_csy_offshore_certificate_disabled}} type="radio" name="csy_offshore_certificate_status"  class="rb_end_deco_no YACHT_3" value="no" {{ ( isset($yacht[0]->csy_offshore_certificate_status) && ($yacht[0]->csy_offshore_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',4, 1)" type="radio" name="is_ds_certificate_competence"  class="rb_datskipcom_yes" value="1" {{(isset($yacht[0]->is_ds_certificate_competence) && ($yacht[0]->is_ds_certificate_competence == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',4, 0)" type="radio" name="is_ds_certificate_competence"  class="rb_datskipcom_no" value="0" {{(isset($yacht[0]->is_ds_certificate_competence) && ($yacht[0]->is_ds_certificate_competence == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_ds_certificate_competence_disabled}} type="radio" name="ds_certificate_competence_status"  class="rb_end_deco_yes YACHT_4" value="yes" {{ ( isset($yacht[0]->ds_certificate_competence_status) && ($yacht[0]->ds_certificate_competence_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_ds_certificate_competence_disabled}} type="radio" name="ds_certificate_competence_status"  class="rb_end_deco_no YACHT_4" value="no" {{ ( isset($yacht[0]->ds_certificate_competence_status  ) && ($yacht[0]->ds_certificate_competence_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',5, 1)" type="radio" name="is_ds_shorebased_certificate"  class="rb_dskshorebase_yes" value="1" {{(isset($yacht[0]->is_ds_shorebased_certificate) && ($yacht[0]->is_ds_shorebased_certificate == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',5, 0)" type="radio" name="is_ds_shorebased_certificate"  class="rb_dskshorebase_no" value="0" {{(isset($yacht[0]->is_ds_shorebased_certificate) && ($yacht[0]->is_ds_shorebased_certificate == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_ds_shorebased_certificate_disabled}} type="radio" name="ds_shorebased_certificate_status"  class="rb_end_deco_yes YACHT_5" value="yes" {{ ( isset($yacht[0]->ds_shorebased_certificate_status) && ($yacht[0]->ds_shorebased_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_ds_shorebased_certificate_disabled}} type="radio" name="ds_shorebased_certificate_status"  class="rb_end_deco_no YACHT_5" value="no" {{ ( isset($yacht[0]->ds_shorebased_certificate_status) && ($yacht[0]->ds_shorebased_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',6, 1)" type="radio" name="is_diesel_engine"  class="rb_dieselegine_yes" value="1" {{(isset($yacht[0]->is_diesel_engine) && ($yacht[0]->is_diesel_engine == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',6, 0)" type="radio" name="is_diesel_engine"  class="rb_dieselegine_no" value="0" {{(isset($yacht[0]->is_diesel_engine) && ($yacht[0]->is_diesel_engine == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_diesel_engine_disabled}} type="radio" name="diesel_engine_status"  class="rb_end_deco_yes YACHT_6" value="yes" {{ ( isset($yacht[0]->diesel_engine_status) && ($yacht[0]->diesel_engine_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_diesel_engine_disabled}} type="radio" name="diesel_engine_status"  class="rb_end_deco_no YACHT_6" value="no" {{ ( isset($yacht[0]->diesel_engine_status) && ($yacht[0]->diesel_engine_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',7, 1)" type="radio" name="is_diveboat_coxswain"  class="rb_divecoxsw_yes" value="1" {{(isset($yacht[0]->is_diveboat_coxswain) && ($yacht[0]->is_diveboat_coxswain == '1') ) ? 'checked': ''  }}> Yes </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',7, 0)" type="radio" name="is_diveboat_coxswain"  class="rb_divecoxsw_no" value="0" {{(isset($yacht[0]->is_diveboat_coxswain) && ($yacht[0]->is_diveboat_coxswain == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_diveboat_coxswain_disabled}} type="radio" name="diveboat_coxswain_status"  class="rb_end_deco_yes YACHT_7" value="yes" {{ ( isset($yacht[0]->diveboat_coxswain_status) && ($yacht[0]->diveboat_coxswain_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_diveboat_coxswain_disabled}} type="radio" name="diveboat_coxswain_status"  class="rb_end_deco_no YACHT_7" value="no" {{ ( isset($yacht[0]->diveboat_coxswain_status) && ($yacht[0]->diveboat_coxswain_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                      
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',8, 1)" type="radio" name="is_diveboat_master"  class="rb_divemster_yes" value="1" {{(isset($yacht[0]->is_diveboat_master) && ($yacht[0]->is_diveboat_master == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',8, 0)" type="radio" name="is_diveboat_master"  class="rb_divemster_no" value="0" {{(isset($yacht[0]->is_diveboat_master) && ($yacht[0]->is_diveboat_master == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_diveboat_master_disabled}} type="radio" name="diveboat_master_status"  class="rb_end_deco_yes YACHT_8" value="yes" {{ ( isset($yacht[0]->diveboat_master_status) && ($yacht[0]->diveboat_master_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_diveboat_master_disabled}} type="radio" name="diveboat_master_status"  class="rb_end_deco_no YACHT_8" value="no" {{ ( isset($yacht[0]->diveboat_master_status) && ($yacht[0]->diveboat_master_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',9, 1)" type="radio" name="is_first_aid"  class="rb_firstaid_yes" value="1" {{(isset($yacht[0]->is_first_aid) && ($yacht[0]->is_first_aid == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',9, 0)" type="radio" name="is_first_aid"  class="rb_firstaid_no" value="0" {{(isset($yacht[0]->is_first_aid) && ($yacht[0]->is_first_aid == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_first_aid_disabled}} type="radio" name="first_aid_status"  class="rb_end_deco_yes YACHT_9" value="yes" {{ ( isset($yacht[0]->first_aid_status) && ($yacht[0]->first_aid_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_first_aid_disabled}} type="radio" name="first_aid_status"  class="rb_end_deco_no YACHT_9" value="no" {{ ( isset($yacht[0]->first_aid_status) && ($yacht[0]->first_aid_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',10, 1)" type="radio" name="is_international_pleasure_craft_certificatee"  class="rb_intercopc_yes" value="1" {{(isset($yacht[0]->is_international_pleasure_craft_certificatee) && ($yacht[0]->is_international_pleasure_craft_certificatee == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('YACHT',10, 0)" type="radio" name="is_international_pleasure_craft_certificatee"  class="rb_intercopc_no" value="0" {{(isset($yacht[0]->is_international_pleasure_craft_certificatee) && ($yacht[0]->is_international_pleasure_craft_certificatee == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_international_pleasure_craft_certificatee_disabled}} type="radio" name="international_pleasure_craft_certificate_status"  class="rb_end_deco_yes YACHT_10" value="yes" {{ ( isset($yacht[0]->international_pleasure_craft_certificate_status) && ($yacht[0]->international_pleasure_craft_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_international_pleasure_craft_certificatee_disabled}} type="radio" name="international_pleasure_craft_certificate_status"  class="rb_end_deco_no YACHT_10" value="no" {{ ( isset($yacht[0]->international_pleasure_craft_certificate_status) && ($yacht[0]->international_pleasure_craft_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr> 
                                                </tbody>
                                            ...
                                            <form name="other_docs_form" method='POST' action="{{ route('anyotherdoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('OTHER',1, 1)" type="radio" name="is_doc_name" class="radio_otherdoc" value="1" {{(isset($any_other_docs[0]->is_doc_name) && ($any_other_docs[0]->is_doc_name == '1') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input onclick="updateValidTable('OTHER',1, 0)" type="radio" name="is_doc_name" class="radio_otherdoc" value="0" {{(isset($any_other_docs[0]->is_doc_name) && ($any_other_docs[0]->is_doc_name == '0') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input  {{$is_doc_name_disabled}} type="radio" name="doc_name_status"  class="rb_end_deco_yes OTHER_1" value="yes" {{ ( isset($any_other_docs[0]->doc_name_status) && ($any_other_docs[0]->doc_name_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input {{$is_doc_name_disabled}} type="radio" name="doc_name_status"  class="rb_end_deco_no OTHER_1" value="no" {{ ( isset($any_other_docs[0]->doc_name_status) && ($any_other_docs[0]->doc_name_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                     
                                                        </td>
                                                    </tr>
                                                </tbody>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#others_submit").click(function(){            
            if(!$("input[name='is_doc_name']").is(':checked') ){  
