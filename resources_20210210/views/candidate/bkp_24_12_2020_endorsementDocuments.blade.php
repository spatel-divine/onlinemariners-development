                                ...
                                <div class="panel panel-default" id="endorsements_tab1">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="endorsement_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default" id="travel_tab2">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="travel_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default" id="medical_tab3">
                                    ...
                                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="medical_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default" id="satc_tab4">
                                    ...
                                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="skills_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default" id="personal_tab5">
                                    ...
                                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="personal_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default" id="coc_tab6">
                                    ...
                                    <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="coc_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default" id="STCW_tab7">
                                    ...
                                    <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                        <div class="panel-body">
                                            ...
                                            <button type="submit" id="stcw_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
                                        <div class="panel-body">
                                           <form name="offshore_form" method='POST' action="{{ route('Offshoredoc.save') }}">
                                            ...
                                            <button type="submit" id="offshore_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
