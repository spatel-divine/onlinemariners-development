...
<?php
    ...
    // if(isset($endors) && empty($endors)){
    //     $docStatus = $profileimg[0]->docs_uploaded;
    // }else{
    //     $docStatus = '1';
    // }
    ...
    if(!empty($yacht)){
        $yachtDocStatus = $yacht[0]->yatch_filled_docs;
    }else{
        $yachtDocStatus = 'yachtNo';
    }

    // echo $endorsDocStatus.'  '.$travelDocStatus.' '.$medicalDocStatus.' '.$skillDocStatus;
    // exit;
    // $travel = empty($travel) ? '0' : '1' ;
    // $medical = empty($medical) ? '0' : '1' ;
    // $skill = empty($skill) ? '0' : '1' ;
    // $personal = empty($personal) ? '0' : '1' ;
    // $coc = empty($coc) ? '0' : '1' ;
    // $stcw = empty($stcw) ? '0' : '1' ;
    // $offshore = empty($offshore) ? '0' : '1' ;
    // $yacht = empty($yacht) ? '0' : '1' ;
    // $any_other_docs = empty($any_other_docs) ? '0' : '1' ;
    // echo $travel.' '.$medical;
    // exit;
                    ...
                    <div class="dashboard-caption">
                        ...
                        <div class="dashboard-caption-wrap">                            
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <form name="endorse_form" method='POST' action="{{ route('endorsment.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>                                                           
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_chemical_dt_status" class="rb_end_chemical_yes" value="yes" {{ (isset($endors->endors_dec_chemical_dt_status) && ($endors->endors_dec_chemical_dt_status == 'yes') ) ? 'checked': ''  }}> Yes </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_chemical_dt_status"  class="rb_end_chemical_no" value="no"  {{ (isset($endors->endors_dec_chemical_dt_status) && ($endors->endors_dec_chemical_dt_status == 'no') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_gas_require" class="rb_end_dec_yes"  value="Yes"> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                        ...
                                                        <td>                                                           
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_gas_dt_status" class="rb_end_chemical_yes" value="yes" {{ (isset($endors->endors_dec_gas_dt_status) && ($endors->endors_dec_gas_dt_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_gas_dt_status"  class="rb_end_chemical_no" value="no" {{ (isset($endors->endors_dec_gas_dt_status) && ($endors->endors_dec_gas_dt_status == 'no') ) ? 'checked': ''  }}> No </label>
                                                            </div> 
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_others_require"  class="rb_end_deco_yes" value="1"> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_others_require"  class="rb_end_deco_no" value="0" checked> No </label>
                                                            </div>
                                                        </td>
                                                        <td>                                                            
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_others_dt_status"  class="rb_end_deco_yes" value="yes" {{ (isset($endors->endors_dec_others_dt_status) && ($endors->endors_dec_others_dt_status == 'yes') ) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_others_dt_status"  class="rb_end_deco_no" value="no" {{ (isset($endors->endors_dec_others_dt_status) && ($endors->endors_dec_others_dt_status == 'no') ) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_petroleum_dt_status"  class="rb_end_deco_yes" value="yes" {{ (isset($endors->endors_dec_petroleum_dt_status) && ($endors->endors_dec_petroleum_dt_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="endors_dec_petroleum_dt_status"  class="rb_end_deco_no" value="no" {{ (isset($endors->endors_dec_petroleum_dt_status) && ($endors->endors_dec_petroleum_dt_status == 'no')) ? 'checked': '' }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>                                                            
                                                           <div class="col-sm-4">
                                                                <?php
                                                                    // echo 'dd'.$travel[0]->passport_status;
                                                                    // exit;
                                                                    // var_dump((isset($travel[0]->passport_status) == 'yes'));
                                                                ?>
                                                                <label class="radio-inline"> <input type="radio" name="passport_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($travel[0]->passport_status) && ($travel[0]->passport_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="passport_status"  class="rb_end_deco_no" value="no" {{ ( isset($travel[0]->passport_status) && ($travel[0]->passport_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>                                                        
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="Seamans_book_cdc_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($travel[0]->Seamans_book_cdc_status) && ($travel[0]->Seamans_book_cdc_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="Seamans_book_cdc_status"  class="rb_end_deco_no" value="no" {{ ( isset($travel[0]->Seamans_book_cdc_status) && ($travel[0]->Seamans_book_cdc_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="uk_work_permit_staus"  class="rb_end_deco_yes" value="yes" {{ ( isset($travel[0]->uk_work_permit_staus) && ($travel[0]->uk_work_permit_staus == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="uk_work_permit_staus"  class="rb_end_deco_no" value="no" {{ ( isset($travel[0]->uk_work_permit_staus) && ($travel[0]->uk_work_permit_staus == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="us_visa_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($travel[0]->us_visa_status) && ($travel[0]->us_visa_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="us_visa_status"  class="rb_end_deco_no" value="no" {{ ( isset($travel[0]->us_visa_status) && ($travel[0]->us_visa_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>                           
                                                </tbody>
                                            ...
                                            <form name="medical_doc_form" method='POST' action="{{ route('medicaldoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="drug_alcohol_blood_test_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($medical[0]->drug_alcohol_blood_test_status) && ($medical[0]->drug_alcohol_blood_test_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="drug_alcohol_blood_test_status"  class="rb_end_deco_no" value="no" {{ ( isset($medical[0]->drug_alcohol_blood_test_status) && ($medical[0]->drug_alcohol_blood_test_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                             
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="seafarers_medical_examination_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($medical[0]->seafarers_medical_examination_status) && ($medical[0]->seafarers_medical_examination_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="seafarers_medical_examination_status"  class="rb_end_deco_no" value="no" {{ ( isset($medical[0]->seafarers_medical_examination_status) && ($medical[0]->seafarers_medical_examination_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ukooa_medical_fitness_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($medical[0]->ukooa_medical_fitness_status) && ($medical[0]->ukooa_medical_fitness_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ukooa_medical_fitness_status"  class="rb_end_deco_no" value="no" {{ ( isset($medical[0]->ukooa_medical_fitness_status) && ($medical[0]->ukooa_medical_fitness_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>                                                           
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="yellow_fever_vaccination_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($medical[0]->yellow_fever_vaccination_status) && ($medical[0]->yellow_fever_vaccination_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="yellow_fever_vaccination_status"  class="rb_end_deco_no" value="no" {{ ( isset($medical[0]->yellow_fever_vaccination_status) && ($medical[0]->yellow_fever_vaccination_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <form name="skill_trainging_doc_form" method='POST' action="{{ route('skilldoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="arpa_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->arpa_status) && ($skill[0]->arpa_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="arpa_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->arpa_status) && ($skill[0]->arpa_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>                                                        
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="behaviour_safety_process_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->behaviour_safety_process_status) && ($skill[0]->behaviour_safety_process_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="behaviour_safety_process_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->behaviour_safety_process_status) && ($skill[0]->behaviour_safety_process_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="boatmaster_license_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->boatmaster_license_status) && ($skill[0]->boatmaster_license_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="boatmaster_license_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->boatmaster_license_status) && ($skill[0]->boatmaster_license_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bridge_team_management_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->bridge_team_management_status) && ($skill[0]->bridge_team_management_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bridge_team_management_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->bridge_team_management_status) && ($skill[0]->bridge_team_management_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="chemical_tankertraining_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->chemical_tankertraining_status) && ($skill[0]->arpa_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="chemical_tankertraining_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->chemical_tankertraining_status) && ($skill[0]->arpa_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="cows_crudeoil_washing_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->cows_crudeoil_washing_status) && ($skill[0]->cows_crudeoil_washing_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="cows_crudeoil_washing_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->cows_crudeoil_washing_status) && ($skill[0]->cows_crudeoil_washing_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="crane_operator_certificate_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->arpa_status) && ($skill[0]->crane_operator_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="crane_operator_certificate_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->arpa_status) && ($skill[0]->crane_operator_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_induction_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->dp_induction_status) && ($skill[0]->dp_induction_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_induction_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->dp_induction_status) && ($skill[0]->dp_induction_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_limited_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->dp_limited_status) && ($skill[0]->dp_limited_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_limited_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->dp_limited_status) && ($skill[0]->dp_limited_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_simulator_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->dp_simulator_status) && ($skill[0]->dp_simulator_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_simulator_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->dp_simulator_status) && ($skill[0]->dp_simulator_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>    
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_full_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->dp_full_status) && ($skill[0]->dp_full_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_full_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->dp_full_status) && ($skill[0]->dp_full_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>     
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_maintenance_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->dp_maintenance_status) && ($skill[0]->dp_maintenance_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="dp_maintenance_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->dp_maintenance_status) && ($skill[0]->dp_maintenance_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ecdis_staus"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->ecdis_staus) && ($skill[0]->ecdis_staus == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ecdis_staus"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->ecdis_staus) && ($skill[0]->ecdis_staus == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>     
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ecdis_kh_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->ecdis_kh_status) && ($skill[0]->ecdis_kh_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ecdis_kh_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->ecdis_kh_status) && ($skill[0]->ecdis_kh_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>    
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="engineroom_simulator_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->engineroom_simulator_status) && ($skill[0]->engineroom_simulator_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="engineroom_simulator_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->engineroom_simulator_status) && ($skill[0]->engineroom_simulator_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="engineroom_simulator_course_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($skill[0]->arpa_status) && ($skill[0]->engineroom_simulator_course_status == 'yes')) ? 'checked': ''  }}> Yes </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="engineroom_simulator_course_status"  class="rb_end_deco_no" value="no" {{ ( isset($skill[0]->arpa_status) && ($skill[0]->engineroom_simulator_course_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>                                                    
                                                </tbody>
                                            ...
                                            <form name="personal_doc_form" method='POST' action="{{ route('personaldoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="driver_license_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($personal[0]->driver_license_status) && ($personal[0]->driver_license_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="driver_license_status"  class="rb_end_deco_no" value="no" {{ ( isset($personal[0]->driver_license_status) && ($personal[0]->driver_license_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="photograph_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($personal[0]->photograph_status) && ($personal[0]->photograph_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="photograph_status"  class="rb_end_deco_no" value="no" {{ ( isset($personal[0]->photograph_status) && ($personal[0]->photograph_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                        
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="resume_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($personal[0]->resume_status) && ($personal[0]->resume_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="resume_status"  class="rb_end_deco_no" value="no" {{ ( isset($personal[0]->resume_status) && ($personal[0]->resume_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="personal_other_docs_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($personal[0]->personal_other_docs_status) && ($personal[0]->personal_other_docs_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="personal_other_docs_status"  class="rb_end_deco_no" value="no" {{ ( isset($personal[0]->personal_other_docs_status) && ($personal[0]->personal_other_docs_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <form name="cocdoc_form" method='POST' action="{{ route('cocDocs.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="officers_incharge_navigational_unlimited_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->officers_incharge_navigational_unlimited_status) && ($coc[0]->officers_incharge_navigational_unlimited_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="officers_incharge_navigational_unlimited_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->officers_incharge_navigational_unlimited_status) && ($coc[0]->officers_incharge_navigational_unlimited_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="master_unlimited_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->master_unlimited_status) && ($coc[0]->master_unlimited_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="master_unlimited_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->master_unlimited_status) && ($coc[0]->master_unlimited_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                  
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="chief_mate_unlimited_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->chief_mate_unlimited_status) && ($coc[0]->chief_mate_unlimited_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="chief_mate_unlimited_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->chief_mate_unlimited_status) && ($coc[0]->chief_mate_unlimited_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                             
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="masters_ships_lessthan_500gt_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->masters_ships_lessthan_500gt_status) && ($coc[0]->masters_ships_lessthan_500gt_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="masters_ships_lessthan_500gt_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->masters_ships_lessthan_500gt_status) && ($coc[0]->masters_ships_lessthan_500gt_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="officers_charge_navigational_less_500_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->officers_charge_navigational_less_500_status) && ($coc[0]->officers_charge_navigational_less_500_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="officers_charge_navigational_less_500_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->officers_charge_navigational_less_500_status) && ($coc[0]->officers_charge_navigational_less_500_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="rating_forming_part_navigational_watch_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->rating_forming_part_navigational_watch_status) && ($coc[0]->rating_forming_part_navigational_watch_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="rating_forming_part_navigational_watch_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->rating_forming_part_navigational_watch_status) && ($coc[0]->rating_forming_part_navigational_watch_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="able_seafarer_deck_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->able_seafarer_deck_status) && ($coc[0]->able_seafarer_deck_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="able_seafarer_deck_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->able_seafarer_deck_status) && ($coc[0]->able_seafarer_deck_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="officer_charge_engineering_watch_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->officer_charge_engineering_watch_status) && ($coc[0]->officer_charge_engineering_watch_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="officer_charge_engineering_watch_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->officer_charge_engineering_watch_status) && ($coc[0]->officer_charge_engineering_watch_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="chief_engineer_officer_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->chief_engineer_officer_status) && ($coc[0]->chief_engineer_officer_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="chief_engineer_officer_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->chief_engineer_officer_status) && ($coc[0]->chief_engineer_officer_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="second_engineer_officer_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($coc[0]->second_engineer_officer_status) && ($coc[0]->second_engineer_officer_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="second_engineer_officer_status"  class="rb_end_deco_no" value="no" {{ ( isset($coc[0]->second_engineer_officer_status) && ($coc[0]->second_engineer_officer_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr> 
                                                </tbody>
                                            ...
                                            <form name="stcwdoc_form" method='POST' action="{{ route('stcwdoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="basic_training_chemical_tc_operations_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->basic_training_chemical_tc_operations_status) && ($stcw[0]->basic_training_chemical_tc_operations_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="basic_training_chemical_tc_operations_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->basic_training_chemical_tc_operations_status) && ($stcw[0]->basic_training_chemical_tc_operations_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="advanced_tc_operations_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->advanced_tc_operations_status) && ($stcw[0]->advanced_tc_operations_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="advanced_tc_operations_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->advanced_tc_operations_status) && ($stcw[0]->advanced_tc_operations_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                 
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="advanced_chemical_tc_operations_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->advanced_chemical_tc_operations_status) && ($stcw[0]->advanced_chemical_tc_operations_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="advanced_chemical_tc_operations_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->advanced_chemical_tc_operations_status) && ($stcw[0]->advanced_chemical_tc_operations_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                             
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bt_liquified_gas_tc_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->bt_liquified_gas_tc_status) && ($stcw[0]->bt_liquified_gas_tc_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bt_liquified_gas_tc_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->bt_liquified_gas_tc_status) && ($stcw[0]->bt_liquified_gas_tc_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="at_for_liquified_gas_tc_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->at_for_liquified_gas_tc_status) && ($stcw[0]->at_for_liquified_gas_tc_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="at_for_liquified_gas_tc_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->at_for_liquified_gas_tc_status) && ($stcw[0]->at_for_liquified_gas_tc_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="crowd_mgt_training_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->crowd_mgt_training_status) && ($stcw[0]->crowd_mgt_training_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="crowd_mgt_training_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->crowd_mgt_training_status) && ($stcw[0]->crowd_mgt_training_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="safety_training_for_personnel_providing_ds_status"  class="rb_end_deco_yes" value="yes" 
                                                                    {{ ( isset($stcw[0]->safety_training_for_personnel_providing_ds_status) && ($stcw[0]->safety_training_for_personnel_providing_ds_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="safety_training_for_personnel_providing_ds_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->safety_training_for_personnel_providing_ds_status) && ($stcw[0]->safety_training_for_personnel_providing_ds_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="crisis_mgt_human_behaviour_training_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->crisis_mgt_human_behaviour_training_status) && ($stcw[0]->crisis_mgt_human_behaviour_training_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="crisis_mgt_human_behaviour_training_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->crisis_mgt_human_behaviour_training_status) && ($stcw[0]->crisis_mgt_human_behaviour_training_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="passenger_cargo_hull_integrity_training_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->passenger_cargo_hull_integrity_training_status) && ($stcw[0]->passenger_cargo_hull_integrity_training_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="passenger_cargo_hull_integrity_training_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->passenger_cargo_hull_integrity_training_status) && ($stcw[0]->passenger_cargo_hull_integrity_training_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="basic_safety_tc_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($stcw[0]->basic_safety_tc_status) && ($stcw[0]->basic_safety_tc_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="basic_safety_tc_status"  class="rb_end_deco_no" value="no" {{ ( isset($stcw[0]->basic_safety_tc_status) && ($stcw[0]->basic_safety_tc_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                ...
                                <!--8 -->
                                <div class="panel panel-default" id="offshore_tab8">
                                           ...
                                           <form name="offshore_form" method='POST' action="{{ route('Offshoredoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt0_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->agt0_status) && ($offshore[0]->agt0_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt0_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->agt0_status) && ($offshore[0]->agt0_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agtl1_cbt_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->agtl1_cbt_status) && ($offshore[0]->agtl1_cbt_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agtl1_cbt_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->agtl1_cbt_status) && ($offshore[0]->agtl1_cbt_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt2_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->agt2_status) && ($offshore[0]->agt2_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt2_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->agt2_status) && ($offshore[0]->agt2_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                               
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt2_cbt_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->agt2_cbt_status) && ($offshore[0]->agt2_cbt_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt2_cbt_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->agt2_cbt_status) && ($offshore[0]->agt2_cbt_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt3_cbt_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->agt3_cbt_status) && ($offshore[0]->agt3_cbt_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="agt3_cbt_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->agt3_cbt_status) && ($offshore[0]->agt3_cbt_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ama_errv_crew_advanced_medical_aid_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->ama_errv_crew_advanced_medical_aid_status) && ($offshore[0]->ama_errv_crew_advanced_medical_aid_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ama_errv_crew_advanced_medical_aid_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->ama_errv_crew_advanced_medical_aid_status) && ($offshore[0]->ama_errv_crew_advanced_medical_aid_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="boat_travel_safely_by_boat_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->boat_travel_safely_by_boat_status) && ($offshore[0]->boat_travel_safely_by_boat_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="boat_travel_safely_by_boat_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->boat_travel_safely_by_boat_status) && ($offshore[0]->boat_travel_safely_by_boat_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="boer_basic_onshore_emergency_response_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->boer_basic_onshore_emergency_response_status) && ($offshore[0]->boer_basic_onshore_emergency_response_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="boer_basic_onshore_emergency_response_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->boer_basic_onshore_emergency_response_status) && ($offshore[0]->boer_basic_onshore_emergency_response_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bosiet_with_ca_ebs_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->bosiet_with_ca_ebs_status) && ($offshore[0]->bosiet_with_ca_ebs_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bosiet_with_ca_ebs_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->bosiet_with_ca_ebs_status) && ($offshore[0]->bosiet_with_ca_ebs_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bosiet_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($offshore[0]->bosiet_status) && ($offshore[0]->bosiet_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="bosiet_status"  class="rb_end_deco_no" value="no" {{ ( isset($offshore[0]->bosiet_status) && ($offshore[0]->bosiet_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    </tr> 
                                                </tbody>
                                ...
                                ?>
                                <!-- 9 -->
                                <div class="panel panel-default" id="yacht_tab9">
                                            ...
                                            <form name="yacht_form" method='POST' action="{{ route('yachtdoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="advanced_powerboat_certificate_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->advanced_powerboat_certificate_status) && ($yacht[0]->advanced_powerboat_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="advanced_powerboat_certificate_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->advanced_powerboat_certificate_status) && ($yacht[0]->advanced_powerboat_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="basic_sea_survival_certificate_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->basic_sea_survival_certificate_status) && ($yacht[0]->basic_sea_survival_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="basic_sea_survival_certificate_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->basic_sea_survival_certificate_status) && ($yacht[0]->basic_sea_survival_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="csy_offshore_certificate_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->csy_offshore_certificate_status) && ($yacht[0]->csy_offshore_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="csy_offshore_certificate_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->csy_offshore_certificate_status) && ($yacht[0]->csy_offshore_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                            
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ds_certificate_competence_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->ds_certificate_competence_status) && ($yacht[0]->ds_certificate_competence_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ds_certificate_competence_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->ds_certificate_competence_status  ) && ($yacht[0]->ds_certificate_competence_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ds_shorebased_certificate_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->ds_shorebased_certificate_status) && ($yacht[0]->ds_shorebased_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="ds_shorebased_certificate_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->ds_shorebased_certificate_status) && ($yacht[0]->ds_shorebased_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                          
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="diesel_engine_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->diesel_engine_status) && ($yacht[0]->diesel_engine_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="diesel_engine_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->diesel_engine_status) && ($yacht[0]->diesel_engine_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="diveboat_coxswain_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->diveboat_coxswain_status) && ($yacht[0]->diveboat_coxswain_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="diveboat_coxswain_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->diveboat_coxswain_status) && ($yacht[0]->diveboat_coxswain_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                      
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="diveboat_master_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->diveboat_master_status) && ($yacht[0]->diveboat_master_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="diveboat_master_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->diveboat_master_status) && ($yacht[0]->diveboat_master_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                         
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="first_aid_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->first_aid_status) && ($yacht[0]->first_aid_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="first_aid_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->first_aid_status) && ($yacht[0]->first_aid_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                                           
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="international_pleasure_craft_certificate_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($yacht[0]->international_pleasure_craft_certificate_status) && ($yacht[0]->international_pleasure_craft_certificate_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="international_pleasure_craft_certificate_status"  class="rb_end_deco_no" value="no" {{ ( isset($yacht[0]->international_pleasure_craft_certificate_status) && ($yacht[0]->international_pleasure_craft_certificate_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>
                                                        </td>
                                                    </tr> 
                                                </tbody>
                                            </table>
                                            <button type="submit" id="yacht_submit" class="btn btn-success btn-primary small-btn">Save Docs</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <form name="other_docs_form" method='POST' action="{{ route('anyotherdoc.save') }}">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="doc_name_status"  class="rb_end_deco_yes" value="yes" {{ ( isset($any_other_docs[0]->doc_name_status) && ($any_other_docs[0]->doc_name_status == 'yes')) ? 'checked': ''  }}> Yes </label>                    
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline"> <input type="radio" name="doc_name_status"  class="rb_end_deco_no" value="no" {{ ( isset($any_other_docs[0]->doc_name_status) && ($any_other_docs[0]->doc_name_status == 'no')) ? 'checked': ''  }}> No </label>
                                                            </div>                                     
                                                        </td>
                                                    </tr>
                                                </tbody>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var yachtDocCount = "<?php  echo $yachtDocStatus ?>";
        // alert(endoresDocCount +' '+travelDocCount+' '+ medicalDocCount+' '+skillDocCount+' '+personalDocCount+' '+cocDocCount+' '+stcwDocCount+' '+offshoreDocCount+' '+yachtDocCount);
        // return false;
        // var any_other_docsDocCount = "<?php  //echo $any_other_docsDocStatus ?>";
        //var travelDocCount = "<?php  //echo $travel ?>";
        ...
        if((endoresDocCount == 1) & (travelDocCount == 'travelNo')){//tab2
            // alert('travelDocCount: '+travelDocCount);
            $('#endorsements_tab1').hide();            
            $('#collapseTwo').addClass(" in");
            $('#travel_tab2 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');;
            $('#travel_tab2').show();            
            $('#medical_tab3').hide();
            $('#satc_tab4').hide();
            $('#personal_tab5').hide();
        ...
        //tab3
        if( (endoresDocCount == 1) &  (medicalDocCount == 'medicalNo')){
            // alert('medicalDocCount: '+medicalDocCount);
            $('#collapseThree').addClass(" in");
            $('#medical_tab3 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').show();
            $('#satc_tab4').hide();
        ...
        //tab4
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) &  (skillDocCount == 'skillNo')){
            
            // alert('123skillDocCount: '+skillDocCount);
            $('#collapseFour').addClass(" in");
            $('#satc_tab4 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').hide();
            $('#satc_tab4').show();
        ...
        //tab5
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) & (skillDocCount == 1) &  (stcwDocCount == 'stcwNo')){
            
            // alert('inner personalDocCount: '+personalDocCount);            
            $('#collapseFive').addClass(" in");
            $('#personal_tab5 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').hide();
            $('#satc_tab4').hide();
        ...
        //tab6
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) & (skillDocCount == 1)& (personalDocCount == 1) &  (cocDocCount == 'cocNo')){
            
            // alert('inner cocDocCount: '+cocDocCount);            
            $('#collapseSix').addClass(" in");
            $('#coc_tab6 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').hide();
            $('#satc_tab4').hide();
        ...
        //tab7
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) & (skillDocCount == 1) & (personalDocCount == 1) & (cocDocCount == 1) &  (stcwDocCount == 'stcwNo')){
           
            // alert('inner stcwDocCount: '+stcwDocCount);            
            $('#collapseSeven').addClass(" in");
            $('#STCW_tab7 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').hide();
            $('#satc_tab4').hide();
        ...
        //tab8
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) & (skillDocCount == 1) & (personalDocCount == 1) & (cocDocCount == 1) & (stcwDocCount == 1) &  (offshoreDocCount == 'offshoreNo')){
           
            // alert('inner offshoreDocCount: '+offshoreDocCount);
            $('#collapseEight').addClass(" in");
            $('#offshore_tab8 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').hide();
            $('#satc_tab4').hide();
        ...
        //tab9
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) & (skillDocCount == 1) & (personalDocCount == 1) & (cocDocCount == 1) & (stcwDocCount == 1) & (offshoreDocCount == 1) &  (yachtDocCount == 'yachtNo')){
           
            // alert('inner yachtDocCount: '+yachtDocCount);
            $('#collapseNine').addClass(" in");
            $('#yacht_tab9 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').hide();
            $('#travel_tab2').hide();
            $('#medical_tab3').hide();
            $('#satc_tab4').hide();
        ...
        if( (endoresDocCount == 1) & (travelDocCount == 1) & (medicalDocCount == 1) & (skillDocCount == 1) & (personalDocCount == 1) & (cocDocCount == 1) & (stcwDocCount == 1) & (offshoreDocCount == 1) &  (yachtDocCount == 1)){
             $('#collapseOne').addClass(" in");
            $('#endorsements_tab1 .panel-heading > .panel-title > a').attr('style', 'background-color:#03a84e;color:white;');
            $('#endorsements_tab1').show();
            $('#travel_tab2').show();
            $('#medical_tab3').show();
            $('#satc_tab4').show();
            $('#personal_tab5').show();
        ...
        $("#endorsement_submit").click(function(){
            ...
            if(!$("input[name='endors_dec_chemical_dt_status']").is(':checked') || 
                !$("input[name='endors_dec_gas_dt_status']").is(':checked') || 
                !$("input[name='endors_dec_others_dt_status']").is(':checked') || 
                !$("input[name='endors_dec_petroleum_dt_status']").is(':checked')){                

                alert('Please select all Endorsements status. Is document valid or not?');
                return false;
            }else{
                $("#endorsement_submit").attr("disabled", false);
                // $("#endorsements_tab1").hide();
                $("#travel_tab2 #collapseTwo").addClass('collapse in');
                return true;
            }
        });
        ...
        $("#travel_submit").click(function(){
            ...
            // var r1_radio_val = $("input[name='endors_dec_chemical_require']:checked").val();
            // var col2_radio_val = $("input[name='endors_dec_chemical_dt_status']:checked").val();
            if(!$("input[name='passport_status']").is(':checked') || 
                !$("input[name='Seamans_book_cdc_status']").is(':checked') || 
                !$("input[name='uk_work_permit_staus']").is(':checked') || 
                !$("input[name='us_visa_status']").is(':checked')){                

                alert('Please select all Travel Documents status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#medical_submit").click(function(){            
            if(!$("input[name='drug_alcohol_blood_test_status']").is(':checked') || 
                !$("input[name='seafarers_medical_examination_status']").is(':checked') || 
                !$("input[name='ukooa_medical_fitness_status']").is(':checked') || 
                !$("input[name='yellow_fever_vaccination_status']").is(':checked')){                

                alert('Please select all Medical Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#skills_submit").click(function(){            
            if(!$("input[name='arpa_status']").is(':checked') || 
                !$("input[name='behaviour_safety_process_status']").is(':checked') || 
                !$("input[name='boatmaster_license_status']").is(':checked') || 
                !$("input[name='bridge_team_management_status']").is(':checked')|| 
                !$("input[name='chemical_tankertraining_status']").is(':checked')|| 
                !$("input[name='cows_crudeoil_washing_status']").is(':checked')|| 
                !$("input[name='crane_operator_certificate_status']").is(':checked')|| 
                !$("input[name='dp_induction_status']").is(':checked')|| 
                !$("input[name='dp_limited_status']").is(':checked')|| 
                !$("input[name='dp_simulator_status']").is(':checked')){                

                alert('Please select all Skills And Training Certificates Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#personal_submit").click(function(){            
            if(!$("input[name='driver_license_status']").is(':checked') || 
                !$("input[name='photograph_status']").is(':checked') || 
                !$("input[name='resume_status']").is(':checked') || 
                !$("input[name='personal_other_docs_status']").is(':checked')){                

                alert('Please select all Personal Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#coc_submit").click(function(){            
            if(!$("input[name='officers_incharge_navigational_unlimited_status']").is(':checked') || 
                !$("input[name='master_unlimited_status']").is(':checked') || 
                !$("input[name='chief_mate_unlimited_status']").is(':checked') || 
                !$("input[name='masters_ships_lessthan_500gt_status']").is(':checked')|| 
                !$("input[name='officers_charge_navigational_less_500_status']").is(':checked')|| 
                !$("input[name='rating_forming_part_navigational_watch_status']").is(':checked')|| 
                !$("input[name='able_seafarer_deck_status']").is(':checked')|| 
                !$("input[name='officer_charge_engineering_watch_status']").is(':checked')|| 
                !$("input[name='chief_engineer_officer_status']").is(':checked')|| 
                !$("input[name='second_engineer_officer_status']").is(':checked')){                

                alert('Please select all COC Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#stcw_submit").click(function(){            
            if(!$("input[name='basic_training_chemical_tc_operations_status']").is(':checked') || 
                !$("input[name='advanced_tc_operations_status']").is(':checked') || 
                !$("input[name='advanced_chemical_tc_operations_status']").is(':checked') || 
                !$("input[name='bt_liquified_gas_tc_status']").is(':checked')|| 
                !$("input[name='at_for_liquified_gas_tc_status']").is(':checked')|| 
                !$("input[name='crowd_mgt_training_status']").is(':checked')|| 
                !$("input[name='safety_training_for_personnel_providing_ds_status']").is(':checked')|| 
                !$("input[name='crisis_mgt_human_behaviour_training_status']").is(':checked')|| 
                !$("input[name='passenger_cargo_hull_integrity_training_status']").is(':checked')|| 
                !$("input[name='basic_safety_tc_status']").is(':checked')){                

                alert('Please select all STCW Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#offshore_submit").click(function(){            
            if(!$("input[name='agt0_status']").is(':checked') || 
                !$("input[name='agtl1_cbt_status']").is(':checked') || 
                !$("input[name='agt2_status']").is(':checked') || 
                !$("input[name='agt2_cbt_status']").is(':checked')|| 
                !$("input[name='agt3_cbt_status']").is(':checked')|| 
                !$("input[name='ama_errv_crew_advanced_medical_aid_status']").is(':checked')|| 
                !$("input[name='boat_travel_safely_by_boat_status']").is(':checked')|| 
                !$("input[name='boer_basic_onshore_emergency_response_status']").is(':checked')|| 
                !$("input[name='bosiet_with_ca_ebs_status']").is(':checked')|| 
                !$("input[name='bosiet_status']").is(':checked')){                

                alert('Please select all Offshore Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#yacht_submit").click(function(){            
            if(!$("input[name='advanced_powerboat_certificate_status']").is(':checked') || 
                !$("input[name='basic_sea_survival_certificate_status']").is(':checked') || 
                !$("input[name='csy_offshore_certificate_status']").is(':checked') || 
                !$("input[name='ds_certificate_competence_status']").is(':checked')|| 
                !$("input[name='ds_shorebased_certificate_status']").is(':checked')|| 
                !$("input[name='diesel_engine_status']").is(':checked')|| 
                !$("input[name='diveboat_coxswain_status']").is(':checked')|| 
                !$("input[name='diveboat_master_status']").is(':checked')|| 
                !$("input[name='first_aid_status']").is(':checked')|| 
                !$("input[name='international_pleasure_craft_certificate_status']").is(':checked')){                

                alert('Please select all Yacht Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("#others_submit").click(function(){            
            if(!$("input[name='doc_name_status']").is(':checked') ){                

                alert('Please select Other Document status. Is document valid or not?');
                return false;
            }else{                
                // $("#endorsements_tab1").hide();
                // $("#travel_tab2 #collapseTwo").addClass('collapse in');
        ...
        $("input[name='endors_dec_chemical_require']").click(function(){
            ...
            if(radio_val == 'Yes'){
                ...
                alert('Select is document valid or not');
            }
            if(radio_val == 'No'){
                $('#endors_dec_chemical_dt').hide();
