                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                                        <input type="number" name="country_code" class="form-control" placeholder="country code" value="{{-- old('country_code') --}}">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="availablefrom" autocomplete="off" id="availablefrom" data-lang="en" data-large-mode="true" data-min-year="2020" data-max-year="" data-disabled-days="08/17/2017,08/18/2017" data-id="datedropper-0" data-theme="my-style" class="form-control" placeholder="Enter Available From" 
