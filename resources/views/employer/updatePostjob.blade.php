						...
						<div class="col-lg-9 col-md-8">
							<div class="dashboard-body">
								...
								<div class="alert alert-success alert-dismissable fade in" style="padding: 2% 0;margin-top: 2%;">
			                        ...
			                        <p style="padding-left: 18px; text-transform: uppercase;">Kindly, Check our <a href="http://onlinemariners.com/knowledgeBase" target="_blank">Knowledge base</a> page to know how to post a job for a candidate and other operations.For other queries contact online mariners chat support. </p>
			                    </div>
								@if( session('success') )
										        ...
										        <table id="BoxTable">
										           ...
										           @if(!empty($wages))   
										           		...
										           		@foreach($wages as $wage_value) 
												            ...
												            <tr id="TextBoxDiv{{$i}}">
												            	<td>
												            		<select onchange="getval(this);" class="form-control rank{{$i}} rank_items" id="rank[{{$i}}]" name="rank[]">
													        ...
													        <td>
													        	<input type="number" class="BoxValClass form-control" name="wage[]" placeholder="Enter wages" value="{{$wage_value->wages}}">
													        </td>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="form-group">
														...
														<input type="text" name="app_deadline" id="app_deadline" class="form-control" placeholder="Enter application deadline date" value="{{ date('m/d/Y', strtotime($postjobs[0]->app_deadline)) }}">
													</div>	
												</div>
												<!-- Vassel Type -->
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="form-group">
														...
														<input type="text" name="joining_port" class="form-control" placeholder="Enter port of joining" value="{{ $postjobs[0]->joining_port }}" required>
													</div>	
												</div>
											</div>
	...
	$(document).ready(function(){
    	...
    	$("#addButton").click(function () {
	     ...
	     jQuery.each(options, function(index, item) {            
	      ...
	      newTextBoxDiv.after().html('<td><select onchange="getval(this);" class="form-control rank' + counter + '" id="rank[' + counter + ']" name="rank[]">'+htmloptions+'</select></td><td><input type="number" step=0.01 name="contract_duration[]"  Step 1.0 class="form-control" placeholder="Enter contract duration" required /></td><td><input type="number" class="BoxValClass form-control" name="wage[]" placeholder="Enter wages"></td>');
