			...
			<div class="full-card">
				...
				<div class="row row-bottom mrg-0">
					...
					<ul class="job-detail-des">
						...
						<li>
							<span class="width20">Job Description:</span>
							<span class="width70">{{ mb_strimwidth($postjobs[0]->job_description, 0, 100, "...") }}</span>
						</li>
						<li>
							<span class="width20">Vessel  Type:</span>
							<span class="width70">{{ $wagelisting[0]->vassel_type }}</span>
						</li>
						<li>
							<span class="width20">Application Deadline:</span><span  class="width70">{{ date('m-d-Y', strtotime($postjobs[0]->app_deadline)) }}</span></li>
						<!-- <li> -->
							<!-- <span>Address:</span> -->
							{{--@php
						...
						?>
						<li><span class="width20">City: </span>
							<span class="width70">{{ isset($city) ? $city : 'Not Update Yet'  }}</span></li>
						<li><span class="width20">Country: </span>
							<span  class="width70">{{ mb_strimwidth($country, 0, 20, "...")  }}</span></li>
						<li><span class="width20">Telephone:</span>
							<span  class="width70">{{ mb_strimwidth($mobileNo, 0, 20, "...")  }}</span></li>						
						<li>
							<span class="width20">Email:</span>
							<span class="width70">{{ mb_strimwidth($employerEmail, 0, 40, "...") }}</span></li>
