    ...
    <div class="row">
      <div class="col-sm-10">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="{{ route('addCandidate') }}" enctype="multipart/form-data" id="addCandidate">
              @csrf
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">Profile Picture(jpg,jpeg,svg)<span style="color: red;">*</span></label>
                  <div class="col-sm-9">                    
                    <input type="file" accept="image/*" name="profile_path" id="profile_path" required>
                  </div>                  
                </div>
                <!-- phone number -->
                <div class="row">
                  ...
                  <div class="form-group">
                      <div class="col-sm-2">
                          <input type="number" name="country_code" class="form-control" placeholder="Country Code" value="" required>
                      </div>
                      <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-3 control-label">Nationality<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <select name="nationality" id="jb-nationality" class="form-control" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">                    
                    <input type="file" name="resume_file" accept="image/*, application/pdf" id="resume_file" required>
                  </div>
                </div>
              <!-- /.box-body -->
