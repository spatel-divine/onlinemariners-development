            ...
            <div class="box-body">
              <table id="example1" data-order='[[ 0, "desc" ]]' class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width: 10%">Email Verification Status</th>
                ...
                <tr>
                  ...
                  <td class="table_td">
                    <form class="form-horizontal" method="post" action="{{ route('deleteCandidate',[ 'candidate_id' => $c->id]) }}">
                        @if($c->resume_file && $c->resume_file!='')
                          <a href="{{ route('download.resume',$c->id) }}" style="margin-right: 10px;" class="btn btn-info btn-xs"><i class="fa fa-download"></i></a>
                        @endif    
