                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <select name="competency_certificate" id="jb-category" class="form-control">
                        ...
                        <option value='Others' {{ $candidate[0]->competency_certificate=='Others' ? 'selected' : ''  }}>Others</option>
                    </select>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <select name="last_vassel_served" id="last-vassel-served" class="form-control">
                          ...
                          <option value="Not Applicable"{{ $candidate[0]->last_vassel_served=='Not Applicable' ? 'selected' : ''  }}>Not Applicable </option>
                      </select>
                  </div>
                </div>
