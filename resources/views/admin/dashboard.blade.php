        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Candidate Job Applications </p>
            </div>
            <div class="icon">
                  ...
                  <td>
                    <?php
                      ...
                      if(isset($user->candidate_chat_id)){
                        $chatid = (isset($user->candidate_chat_id)) ? $user->candidate_chat_id : '';
                      }else{
                        $chatid = (isset($user->employer_chat_id)) ? $user->employer_chat_id : '';
                      }
