    ...
    <div class="row">
      <div class="col-sm-10">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="{{ route('admin.updateDocs') }}" enctype="multipart/form-data" >
              @csrf
              ...
              <div class="box-body">
                ...
                <?php
                  // echo "<pre>";
                  // print_r($documentList[0]->document_name);
                  // exit();
                ?>
                <input type="hidden" name="id" value="{{ $documentList[0]->id }}">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Name</label>
                  <div class="col-sm-9">
                    <input type="text" name="document_name" class="form-control" value="{{ $documentList[0]->document_name }}" placeholder="Name" required>
                  </div>
                </div>
                
              <!-- /.box-body -->
              <div class="box-footer">
                <button type="submit" class="col-sm-offset-4 btn btn-default">Update</button>
