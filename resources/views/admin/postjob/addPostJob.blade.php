            ...
            <form class="form-horizontal add-employee-form" method="POST" action="{{ route('insertNewPostJob') }}" enctype="multipart/form-data" >
              ...
              <?php /*   <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="app_deadline" class="form-control" value="" placeholder="Select Application Deadline Date" id="app_deadline" autocomplete="off" required>
                  </div>
                </div>
    ...
    //Add button
      ...
      $("#addButton").click(function () {
       ...
       jQuery.each(options, function(index, item) {            
		...
		newTextBoxDiv.after().html('<td><select onchange="getval(this);" class="form-control rank" id="rank[' + counter + ']" name="rank[' + counter + ']">'+htmloptions+'</select></td><td><input type="number" step=0.01 name="contract_duration[]"  Step 0.5 class="form-control" placeholder="Contract Duration" required /></td><td><input type="number" class="BoxValClass form-control" name="wage[]" placeholder="Enter Wages"></td>');
