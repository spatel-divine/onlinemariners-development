            ...
            <div class="container">
                <div class="banner-caption">
                    <div class="col-md-12 col-sm-12 banner-text">
                    	<!--<center><img src="{{ url('public/assets/img/logo.png') }}" class="logo logo-display" alt=""></center> -->
                        <h1>Browse Jobs</h1>
									...
									<div class="col-lg-2 col-md-2 col-sm-12 small-padd">
										<div class="form-group">
											<div class="form-group">
												...
												<button type="submit" style="background-color: #0671A3;border-color:#0671A3" class="btn btn-primary full-width mobile-sbtn">Search</button>
											</div>
										</div>
									</div>
