...
?>
<!-- Title Header Start -->
<section class="inner-header-title" style="padding: 5em !important; background-image:url({{ url('public/assets/img/online_mariners_bredcrump.jpg') }} ">
	<div class="container">
						...
						<form method="POST" action="{{ route('save.rank') }}">
	                        ...
	                        <div class="row" style="padding: 4% 0 4% 0">
	                            <div class="col-lg-4 col-md-6 col-sm-12">
	                                <label style="font-size: 1.1em;">Choose Rank you want to apply for*</label>
	                            </div>
							...
							<div class="form-groups col-lg-offset-3" style="max-width: 40%; text-align: center; ">
